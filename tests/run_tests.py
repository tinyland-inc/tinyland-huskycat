...
class TestRunner:
    ...
    def run_fast_tests(self) -> bool:
        ...
        cmd = [
            ...
            str(self.test_dir),
            "-m",
            "not slow and not e2e and not container",
            "--maxfail=3",
            "--tb=short",
            "-q",
            "--durations=5",
    ...
    def _generate_ci_summary(self, results: List[tuple]) -> None:
        ...
        summary = {
            ...
            "results": [
                {"phase": phase, "passed": result} for phase, result in results
            ],
        }
...
def main():
    ...
    parser.add_argument("-k", "--pattern", help="Run tests matching specific pattern")
