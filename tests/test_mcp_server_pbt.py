...
class TestMCPServerProperties:
    ...
    def test_server_validates_request_structure(self, invalid_request):
        ...
        assume("jsonrpc" not in invalid_request or invalid_request.get("jsonrpc") != "2.0")
...
class TestMCPProtocolCompliance:
    ...
    def test_unknown_method_returns_error(self, unknown_method, params):
        ...
        assume(unknown_method not in [
            "tools/list", "tools/call", "validate", "validate_staged",
            "validate_black", "validate_flake8", "validate_mypy",
            "validate_yamllint", "validate_hadolint", "validate_shellcheck"
        ])
