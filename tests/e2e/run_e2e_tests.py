...
class E2ETestRunner:
    ...
    def generate_summary_report(self, results: Dict[str, Dict[str, Any]]) -> Dict[str, Any]:
...
def main():
    ...
    parser.add_argument("--suite", choices=[
        "all", "playwright", "mcp", "cicd", "performance"
    ], default="all", help="Test suite to run")
    
    parser.add_argument("--browser", choices=[
        "chromium", "firefox", "webkit"
    ], default="chromium", help="Browser for Playwright tests")
